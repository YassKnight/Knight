...
public class BikingRouteOverlay extends OverlayManager {
    ...
    private boolean isShowStart = false,isShowEnd = false;
...
//                            .anchor(0.5f, 0.5f)
//                            .extraInfo(b)
//                            .icon(BitmapDescriptorFactory.fromResource(R.mipmap.icon_line_node)));
//                }
...
//                }
        ...
        // starting
//        if (mRouteLine.getStarting() != null && isShowStart) {
//            overlayList.add((new MarkerOptions())
//                    .position(mRouteLine.getStarting().getLocation())
//                    .icon(getStartMarker() != null ? getStartMarker() :
//                            BitmapDescriptorFactory.fromResource(R.mipmap.lushu_edit_map_startpoint)).zIndex(10));
//        }
        // terminal
//        if (mRouteLine.getTerminal() != null && isShowEnd) {
//            overlayList
//                    .add((new MarkerOptions())
//                            .position(mRouteLine.getTerminal().getLocation())
//                            .icon(getTerminalMarker() != null ? getTerminalMarker() :
//                                    BitmapDescriptorFactory.fromResource(R.mipmap.lushu_edit_map_endpoint))
//                            .zIndex(10));
//        }
